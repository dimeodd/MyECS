...
namespace MyEcs
{
        ...
        where T1 : struct
    {
        ...
        internal int[] id_1 = new int[EcsWorld.FILTER_LINKS_SIZE]; // cписок ссылок на данные
        ...
        public override Enumerator GetEnumerator()
        {
            lock (key)
            {
                ...
                if (changes_1 != wChanges)
                {
                    ...
                    GetDataIdFromEntitys<T1>(filter).CopyToArray(ref id_1); //FIXME сделать постепенное освобождение памяти, если она не использкется >10(?) вызовов
                    Count = filter.Count;
                }
            }
            ...
            public override Enumerator GetEnumerator()
            {
                lock (key)
                {
                     ...
                     || changes_e1 != chE1)
                    {
                        ...
                        GetDataIdFromEntitys<T1>(filter).CopyToArray(ref id_1);
                        Count = filter.Count;
                    }
                }
                return new Enumerator(this);
        ...
        where T2 : struct
    {
        ...
        internal int[] id_2 = new int[EcsWorld.FILTER_LINKS_SIZE];  // cписок ссылок на данные
        ...
        public override Enumerator GetEnumerator()
        {
            lock (key)
            {
                 ...
                 || changes_2 != chI2)
                {
                    ...
                    GetDataIdFromEntitys<T1>(filter).CopyToArray(ref id_1);
                    GetDataIdFromEntitys<T2>(filter).CopyToArray(ref id_2);
                    Count = filter.Count;
                }
            }
            return new Enumerator(this);
        ...
        where T3 : struct
    {
        ...
        internal int[] id_3 = new int[EcsWorld.FILTER_LINKS_SIZE];  // cписок ссылок на данные
        ...
        public override Enumerator GetEnumerator()
        {
            lock (key)
            {
                 ...
                 || changes_3 != chI3)
                {
                    ...
                    GetDataIdFromEntitys<T1>(filter).CopyToArray(ref id_1);
                    GetDataIdFromEntitys<T2>(filter).CopyToArray(ref id_2);
                    GetDataIdFromEntitys<T3>(filter).CopyToArray(ref id_3);
                    Count = filter.Count;
                }
            }
            return new Enumerator(this);
        ...
        where T4 : struct
    {
        ...
        internal int[] id_4 = new int[EcsWorld.FILTER_LINKS_SIZE];  // cписок ссылок на данные
        ...
        public override Enumerator GetEnumerator()
        {
            lock (key)
            {
                 ...
                 || changes_4 != chI4)
                {
                    ...
                    GetDataIdFromEntitys<T2>(filter).CopyToArray(ref id_2);
                    GetDataIdFromEntitys<T3>(filter).CopyToArray(ref id_3);
                    GetDataIdFromEntitys<T4>(filter).CopyToArray(ref id_4);
                    Count = filter.Count;
                }
            }
            return new Enumerator(this);
        ...
        where T5 : struct
    {
        ...
        internal int[] id_5 = new int[EcsWorld.FILTER_LINKS_SIZE];  // cписок ссылок на данные
        ...
        public override Enumerator GetEnumerator()
        {
            lock (key)
            {
                 ...
                 || changes_5 != chI5)
                {
                    ...
                    GetDataIdFromEntitys<T3>(filter).CopyToArray(ref id_3);
                    GetDataIdFromEntitys<T4>(filter).CopyToArray(ref id_4);
                    GetDataIdFromEntitys<T5>(filter).CopyToArray(ref id_5);
                    Count = filter.Count;
                }
            }
            return new Enumerator(this);
